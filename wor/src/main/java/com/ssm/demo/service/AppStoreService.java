...
public interface AppStoreService {
    public int newAppBasic(String basicInformation,String author,String name,String type);//新增App基础信息
    ...
    public int judgeA(String userId,String password);/*判断用户名是否存在，与密码是否对应；返回结果4种，
                                                             用户名不存在返回“用户名不存在，”
                                                             密码不匹配返回“密码错误 ”
